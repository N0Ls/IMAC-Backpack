...
Eigen::MatrixXd Strassen(const Eigen::MatrixXd &m1, const Eigen::MatrixXd &m2){
  ...
  Eigen::MatrixXd matRes(m1.rows(),m1.cols());
...
int main()
{
  ...
  std::cout << std::setprecision(20)<<"Eigen mat product    : " << tempsCalc/nThread << std::endl;
//  std::cout <<  std::setprecision(20) <<"Error Matrix " << errorMatrix(resMatProd,resMatProdEigen)<< '\n';
  ...
  std::cout << std::setprecision(20)<<"Strassen mat product : " << tempsCalc/nThread<< std::endl;
  return 0;
